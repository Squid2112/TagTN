...
// ---------------------< onApplicationStart >---------------------
	public boolean function onApplicationStart() {
		...
		Application.Settings = {
			...
			forceMobile = true,
			abuseRedirect = "",
			processExceptions = ["/com/","/css/","/js/","/assets/","flex2gateway","/cfide/","favicon.ico","robots.txt"],
		...
		try {
			...
			fileWrite(Application.Settings.rootPath & "error-com.com.System.SystemComponent.html",result,"utf-8");
		...
		try {
			...
			saveContent variable="result" { writeDump(E); }
			fileWrite(Application.Settings.rootPath & "error-Application.System.loadFrameworkObjects-Application.html",result,"utf-8");
		...
		try {
			...
			saveContent variable="result" { writeDump(E); }
			fileWrite(Application.Settings.rootPath & "error-Application.System.fillCache.html",result,"utf-8");
