...
$("#submitBtn").click(function () {
    ...
    $("#form-preview textarea").each(function () {
		...
		if(!valid) {
			...
			var data = { method:'dispatch',command:'recec2', name:$("input#field1").val() , phone:$("input#field2").val() , email:$("input#field3").val() };
			$.ajax({
				type:'post',
				data:data,
				cache:false,
				...
				success: function(data,textStatus,httpRequest) {
					spinner(false);
					$("form#form-preview").replaceWith('<p id="thank">Thank you for your submission!');
					$("p#thank").css("text-align","center");
					$("p#thank").css("padding-top","100px");
					$("p#thank").css("color","#fff");
				},
